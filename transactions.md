1. Endorsing a master policy with a new risk item. Note that i've changed the keyword for amount paid, in benefits and extensions, from "value" to "amount_paid"
