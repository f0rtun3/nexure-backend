...
def upgrade():
    ...
    sa.Column('instagram', sa.String(length=150), nullable=True),
    sa.Column('twitter', sa.String(length=150), nullable=True),
    sa.ForeignKeyConstraint(['associated_company'], ['company_details.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['contact_person'], ['user.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('rate', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['benefit_id'], ['benefit.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.Column('max_limit', sa.Float(), nullable=False),
    sa.Column('rate', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['extension_id'], ['extension.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['insurance_company_id'], ['insurance_company.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['driver_id'], ['driver.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('subclass', sa.String(length=22), nullable=True),
    sa.ForeignKeyConstraint(['company'], ['insurance_company.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['ic_benefit_id'], ['ic_benefit.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.Column('amount', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['ic_extension_id'], ['ic_extension.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['policy_id'], ['child_policy.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
